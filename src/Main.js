...
class Main extends Component {
  ...
  handleCasePrice = () => {
    const wines = [...this.state.wines];
    wines[0].casePrice = wines[0].value <= 10 ? wines[0].casePrice : wines[0].casePrice * 0.85;
  ...
  handleIncrement = wine => {
    ...
    wines[0].casePrice = wines[0].value < 10 ? wines[0].casePrice : (wines[0].casePrice = 153);
  ...
  handleDecrement = wine => {
    ...
    const totalPrice = wines[0].total + wines[1].total + wines[2].total;
    const totalCases = wines[0].value + wines[1].value + wines[2].value;
    wines[0].casePrice = wines[0].value > 10 ? wines[0].casePrice : (wines[0].casePrice = 180);
    this.setState({ wines, totalPrice, totalCases });
  };
